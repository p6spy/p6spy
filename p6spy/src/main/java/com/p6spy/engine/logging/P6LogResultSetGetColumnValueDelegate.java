 ...
 * @since 09/2013
 */
public class P6LogResultSetGetColumnValueDelegate implements Delegate {


  private final P6LogResultSetInformation resultSetInformation;

  public P6LogResultSetGetColumnValueDelegate(final P6LogResultSetInformation resultSetInformation) {
