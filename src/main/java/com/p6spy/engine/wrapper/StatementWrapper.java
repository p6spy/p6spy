...
public class StatementWrapper extends AbstractWrapper implements Statement {
  ...
  public int[] executeBatch() throws SQLException {
    ...
    try {
      ...
      eventListener.onAfterExecuteBatch(statementInformation, System.nanoTime() - start, e);
    }
  }
  ...
  public int executeUpdate(String sql) throws SQLException {
    ...
    try {
      ...
      eventListener.onAfterExecuteUpdate(statementInformation, System.nanoTime() - start, sql, e);
    }
  }
